...
Download the JSBSim source from [JSBSim release section](https://github.com/JSBSim-Team/jsbsim/releases/tag/v0.99.112).

Alternatively, you can clone the source using git:

```bash
> git clone https://github.com/JSBSim-Team/jsbsim/tree/v0.99.112
```
...
A Windows installer `JSBSim-0.99.112-setup.exe` is available from [JSBSim release section](https://github.com/JSBSim-Team/jsbsim/releases/tag/v0.99.112). Download the installer and set up JSBSim in the following local directory tree
