...
Download the JSBSim source from [JSBSim release section](https://github.com/JSBSim-Team/jsbsim/releases/tag/v0.99.116.dev1).

Alternatively, you can clone the source using git:

```bash
> git clone https://github.com/JSBSim-Team/jsbsim/tree/v0.99.116.dev1
```
...
A Windows installer `JSBSim-0.99.116.dev1-setup.exe` is available from [JSBSim release section](https://github.com/JSBSim-Team/jsbsim/releases/tag/v0.99.116.dev1). Download the installer and set up JSBSim in the following local directory tree
...
> **NOTE:** The JSBSim library file located at `lib\JSBSim.lib` has been compiled with Microsoft Visual Studio Enterprise 2022 (build 17.14.37012.4)
